...
\begin{center}
\begin{tabular}{ccc}
\img[width=0.31\textwidth]{assets/bloom1.jpg} &
\img[width=0.31\textwidth]{assets/bloom2.jpg} &
\img[width=0.31\textwidth]{assets/bloom3.jpg} \\
\scriptsize $T=24,\ \alpha=0.05,\ \sigma=0.5$ &
\scriptsize $T=21,\ \alpha=0.65,\ \sigma=1.2$ &
\scriptsize $T=144,\ \alpha=1.8,\ \sigma=11.3$ \\
\img[width=0.31\textwidth]{assets/bloom1graph.jpg} &
\img[width=0.31\textwidth]{assets/bloom2graph.jpg} &
\img[width=0.31\textwidth]{assets/bloom3graph.jpg}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{ccc}
\img[width=0.31\textwidth]{assets/bloomsample1.jpg} &
\img[width=0.31\textwidth]{assets/bloomsample2.jpg} &
\img[width=0.31\textwidth]{assets/bloomsample3.jpg}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{ccc}
\img[width=0.31\textwidth]{assets/orton1.jpg} &
\img[width=0.31\textwidth]{assets/orton2.jpg} &
\img[width=0.31\textwidth]{assets/orton3.jpg} \\
\scriptsize $\alpha=0.15,\ \sigma=0.1$ &
\scriptsize $\alpha=0.45,\ \sigma=8.5$ &
\scriptsize $\alpha=1.0,\ \sigma=19.1$ \\
\img[width=0.31\textwidth]{assets/orton1graph.jpg} &
\img[width=0.31\textwidth]{assets/orton2graph.jpg} &
\img[width=0.31\textwidth]{assets/orton3graph3.jpg}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{ccc}
\img[width=0.31\textwidth]{assets/ortonsample1.jpg} &
\img[width=0.31\textwidth]{assets/ortonsample2.jpg} &
\img[width=0.31\textwidth]{assets/ortonsample3.jpg}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{ccc}
\img[width=0.31\textwidth]{assets/gamma1.jpg} &
\img[width=0.31\textwidth]{assets/gamma2.jpg} &
\img[width=0.31\textwidth]{assets/gamma3.jpg} \\
\scriptsize $\gamma=0.2$ & \scriptsize $\gamma=1.0$ & \scriptsize $\gamma=1.95$ \\
\img[width=0.31\textwidth]{assets/gamma1graph.jpg} &
\img[width=0.31\textwidth]{assets/gamma2graph.jpg} &
\img[width=0.31\textwidth]{assets/gamma3graph.jpg}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{ccc}
\img[width=0.31\textwidth]{assets/gammasample1.jpg} &
\img[width=0.31\textwidth]{assets/gammasample2.jpg} &
\img[width=0.31\textwidth]{assets/gammasample3.jpg}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{ccc}
\img[width=0.31\textwidth]{assets/dodge1.jpg} &
\img[width=0.31\textwidth]{assets/dodge2.jpg} &
\img[width=0.31\textwidth]{assets/dodge3.jpg} \\
\scriptsize $s=0.01$ & \scriptsize $s=0.5$ & \scriptsize $s=0.90$ \\
\img[width=0.31\textwidth]{assets/dodge1graph.jpg} &
\img[width=0.31\textwidth]{assets/dodge2graph.jpg} &
\img[width=0.31\textwidth]{assets/dodge3graph.jpg}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{ccc}
\img[width=0.31\textwidth]{assets/dodgesample1.jpg} &
\img[width=0.31\textwidth]{assets/dodgesample2.jpg} &
\img[width=0.31\textwidth]{assets/dodgesample3.jpg}
\end{tabular}
\end{center}
